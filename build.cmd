...
%_msbuildexe% %msbuildflags% src/fsharp-library-build.proj /p:TargetFramework=monotouch /p:Configuration=%BUILD_CONFIG%
@if ERRORLEVEL 1 echo Error: library monotouch build failed && goto :failure
)
