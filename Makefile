...
build-proto:
	...
	MONO_ENV_OPTIONS=$(monoopts) $(MSBUILD) /verbosity:detailed /p:Configuration=Proto /p:TargetDotnetProfile=$(TargetDotnetProfile) src/fsharp/Fsc-proto/Fsc-proto.fsproj
