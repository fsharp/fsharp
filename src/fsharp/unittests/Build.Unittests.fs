...
open Microsoft.FSharp.UnitTest.FilesystemHelpers
...
type TheTests() = 
    ...
    member public this.TestCodePage() =
        ...
        printfn "cmd=\"%s\"" cmd
        AssertEqual "--codepage:65001 --optimize+ --warnaserror:76 --fullpaths --flaterrors" cmd
    ...
    member public this.TestDebugSymbols() =
        ...
        let cmd = tool.InternalGenerateCommandLineCommands()
        printfn "cmd=\"%s\"" cmd
        AssertEqual "-g --optimize+ --warnaserror:76 --fullpaths --flaterrors" cmd
    ...
    member public this.TestDebugType() =
        ...
        let cmd = tool.InternalGenerateCommandLineCommands()
        printfn "cmd=\"%s\"" cmd
        AssertEqual "--debug:pdbonly --optimize+ --warnaserror:76 --fullpaths --flaterrors" cmd
    ...
    member public this.TestDefineConstants() =
        ...
        let cmd = tool.InternalGenerateCommandLineCommands()
        printfn "cmd=\"%s\"" cmd
        AssertEqual "--define:FOO=3 --define:BAR=4 --optimize+ --warnaserror:76 --fullpaths --flaterrors" cmd
    ...
    member public this.TestDisabledWarnings1() =
        ...
        let cmd = tool.InternalGenerateCommandLineCommands()
        printfn "cmd=\"%s\"" cmd
        AssertEqual "--optimize+ --nowarn:52,109 --warnaserror:76 --fullpaths --flaterrors" cmd
    ...
    member public this.TestDisabledWarnings2() =
        ...
        let cmd = tool.InternalGenerateCommandLineCommands()
        printfn "cmd=\"%s\"" cmd
        AssertEqual "--optimize+ --warnaserror:76 --fullpaths --flaterrors" cmd
    ...
    member public this.TestVersionFile() =
        ...
        let cmd = tool.InternalGenerateCommandLineCommands()
        printfn "cmd=\"%s\"" cmd
        AssertEqual "--optimize+ --versionfile:src/version --warnaserror:76 --fullpaths --flaterrors" cmd        
    ...
    member public this.TestDocumentationFile() =
        ...
        let cmd = tool.InternalGenerateCommandLineCommands()
        printfn "cmd=\"%s\"" cmd
        AssertEqual "--doc:foo.xml --optimize+ --warnaserror:76 --fullpaths --flaterrors" cmd
    ...
    member public this.TestGenerateInterfaceFile() =
        ...
        let cmd = tool.InternalGenerateCommandLineCommands()
        printfn "cmd=\"%s\"" cmd
        AssertEqual "--sig:foo.fsi --optimize+ --warnaserror:76 --fullpaths --flaterrors" cmd
    ...
    member public this.TestKeyFile() =
        ...
        let cmd = tool.InternalGenerateCommandLineCommands()
        printfn "cmd=\"%s\"" cmd
        AssertEqual "--keyfile:key.txt --optimize+ --warnaserror:76 --fullpaths --flaterrors" cmd
    ...
    member public this.TestNoFramework() =
        ...
        let cmd = tool.InternalGenerateCommandLineCommands()
        printfn "cmd=\"%s\"" cmd
        AssertEqual "--noframework --optimize+ --warnaserror:76 --fullpaths --flaterrors" cmd
    ...
    member public this.TestOptimize() =
        ...
        let cmd = tool.InternalGenerateCommandLineCommands()
        printfn "cmd=\"%s\"" cmd
        AssertEqual cmd "--optimize- --warnaserror:76 --fullpaths --flaterrors"
    ...
    member public this.TestOtherFlags() =
        ...
        let cmd = tool.InternalGenerateCommandLineCommands()
        printfn "cmd=\"%s\"" cmd
        AssertEqual "--optimize+ --warnaserror:76 --fullpaths --flaterrors --yadda yadda" cmd
    ...
    member public this.TestOutputAssembly() =
        ...
        let cmd = tool.InternalGenerateCommandLineCommands()
        printfn "cmd=\"%s\"" cmd
        AssertEqual "-o:oUt.dll --optimize+ --warnaserror:76 --fullpaths --flaterrors" cmd
    ...
    member public this.TestPdbFile() =
        ...
        let cmd = tool.InternalGenerateCommandLineCommands()
        printfn "cmd=\"%s\"" cmd
        AssertEqual "--optimize+ --pdb:out.pdb --warnaserror:76 --fullpaths --flaterrors" cmd
    ...
    member public this.TestPlatform1() =
        ...
        let cmd = tool.InternalGenerateCommandLineCommands()
        printfn "cmd=\"%s\"" cmd
        AssertEqual "--optimize+ --platform:x64 --warnaserror:76 --fullpaths --flaterrors" cmd
    ...
    member public this.TestPlatform2() =
        ...
        let cmd = tool.InternalGenerateCommandLineCommands()
        printfn "cmd=\"%s\"" cmd
        AssertEqual "--optimize+ --platform:Itanium --warnaserror:76 --fullpaths --flaterrors" cmd
    ...
    member public this.TestPlatform3() =
        ...
        let cmd = tool.InternalGenerateCommandLineCommands()
        printfn "cmd=\"%s\"" cmd
        AssertEqual "--optimize+ --platform:x86 --warnaserror:76 --fullpaths --flaterrors" cmd
    ...
    member public this.TestReferences() =
        ...
        let cmd = tool.InternalGenerateCommandLineCommands()
        printfn "cmd=\"%s\"" cmd
        AssertEqual ("--optimize+ -r:" + dll + " --warnaserror:76 --fullpaths --flaterrors") cmd
    ...
    member public this.TestReferencePath() =
        ...
        let cmd = tool.InternalGenerateCommandLineCommands()
        printfn "cmd=\"%s\"" cmd
        AssertEqual ("--optimize+ --lib:c:\\sd\\staging\\tools\\nunit\\,c:\\Foo --warnaserror:76 --fullpaths --flaterrors") cmd
    ...
    member public this.TestResources() =
        ...
        let cmd = tool.InternalGenerateCommandLineCommands()
        printfn "cmd=\"%s\"" cmd
        AssertEqual "--optimize+ --resource:Foo.resources --warnaserror:76 --fullpaths --flaterrors" cmd
    ...
    member public this.TestSources() =
        ...
        let cmd = tool.InternalGenerateCommandLineCommands()
        printfn "cmd=\"%s\"" cmd
        let expect = "--optimize+ --warnaserror:76 --fullpaths --flaterrors " + src + " " + src
    ...
    member public this.TestTargetType1() =
        ...
        let cmd = tool.InternalGenerateCommandLineCommands()
        printfn "cmd=\"%s\"" cmd
        AssertEqual "--optimize+ --target:library --warnaserror:76 --fullpaths --flaterrors" cmd
    ...
    member public this.TestTargetType2() =
        ...
        let cmd = tool.InternalGenerateCommandLineCommands()
        printfn "cmd=\"%s\"" cmd
        AssertEqual "--optimize+ --target:winexe --warnaserror:76 --fullpaths --flaterrors" cmd
    ...
    member public this.TestTargetType3() =
        ...
        let cmd = tool.InternalGenerateCommandLineCommands()
        printfn "cmd=\"%s\"" cmd
        AssertEqual "--optimize+ --target:module --warnaserror:76 --fullpaths --flaterrors" cmd
    ...
    member public this.TestUtf8Output() =
        ...
        let cmd = tool.InternalGenerateCommandLineCommands()
        printfn "cmd=\"%s\"" cmd
        AssertEqual "--optimize+ --warnaserror:76 --utf8output --fullpaths --flaterrors" cmd
    ...
    member public this.TestWin32Res() =
        ...
        let cmd = tool.InternalGenerateCommandLineCommands()
        printfn "cmd=\"%s\"" cmd
        AssertEqual "--optimize+ --warnaserror:76 --win32res:foo.res --fullpaths --flaterrors" cmd
    ...
    member public this.TestWin32Manifest() =
        ...
        let cmd = tool.InternalGenerateCommandLineCommands()
        printfn "cmd=\"%s\"" cmd
        AssertEqual "--optimize+ --warnaserror:76 --win32manifest:foo.manifest --fullpaths --flaterrors" cmd 
    ...
    member public this.TestAllCombo() =
        ...
        let expected = "-o:out.dll --codepage:65001 -g --debug:full --noframework " +
                       ...
                       "--warn:4 --warnaserror --warnaserror:76 --utf8output --fullpaths --flaterrors " +
                       "--yadda:yadda --other:\"internal quote\" blah foo.fs \"C:\\Program Files\\spaces.fs\""
