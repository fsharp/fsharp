...
val internal BindCcu : CcuThunk -> LazyModuleInfo -> IncrementalOptimizationEnv -> IncrementalOptimizationEnv

/// The entry point. Boolean indicates 'incremental extension' in FSI 
val internal OptimizeImplFile : OptimizationSettings *  CcuThunk (* scope *) * Env.TcGlobals * Import.ImportMap * IncrementalOptimizationEnv * isIncrementalFragment: bool * emitTaicalls: bool * TypedImplFile -> IncrementalOptimizationEnv * TypedImplFile * LazyModuleInfo
